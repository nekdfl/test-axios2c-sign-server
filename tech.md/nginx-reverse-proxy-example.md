...
Ниже — **пример** конфигурации: Nginx на порту **8081** проксирует на встроенный HTTP-сервер Axis2 на **127.0.0.1:8080** (тот, что поднимает `demo-sign-server` / `./scripts/run.sh`).
